...
const L:Record<number,{id:string;title:string;boss:boolean}[]>={
  1:[{id:'001-discover-m',title:'发现 /m/',boss:false},{id:'002-discover-s',title:'发现 /s/',boss:false},{id:'003-discover-n',title:'发现 /n/',boss:false},{id:'003-sound-match',title:'回声匹配',boss:false},{id:'004-sound-lab',title:'声音实验室',boss:false},{id:'005-boss-sounds',title:'共振试炼',boss:true}],
  ...
  return (
    <div className="flex flex-col items-center min-h-full p-6 overflow-auto paper-texture" style={{ background: 'linear-gradient(180deg, #fdf8f0 0%, #f5ede0 50%, #efe5d2 100%)' }}>
      ...
      <div className="w-full max-w-2xl flex items-center justify-between mb-8 animate-in">
        ...
        <span className="text-xs text-[#9b8c78] font-medium">探险者</span>
      </div>
      ...
      <div className="flex gap-4 flex-wrap justify-center max-w-2xl stagger-reveal">
        {lvs.map((lv,i)=>(
